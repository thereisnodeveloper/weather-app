...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/amdev/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20301cc2fec26e9cd5ed83GR4bTUkIUFBaB1UBXAdRDAZcXgEB'}); } catch(cjsError) { try { import('file:///home/amdev/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20301cc2fec26e9cd5ed83GR4bTUkIUFBaB1UBXAdRDAZcXgEB'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
